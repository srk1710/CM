...
import intro.cm.cm.R;
import intro.cm.cm.DatabaseHelper;
import intro.cm.cm.model.Note;
import intro.cm.cm.MyDividerItemDecoration;
import intro.cm.cm.RecyclerTouchListener;
...
public class NotasActivity extends AppCompatActivity {
    ...
    private void showNoteDialog(final boolean shouldUpdate, final Note note, final int position) {
        ...
        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(NotasActivity.this);
